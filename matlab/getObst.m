...
switch idx
	...
	case 5 % Two circles       
		par = struct('obsts', [struct('par', @(t) [sin(2*pi*t); cos(2*pi*t)]/2, 'gradnorm',... % Article limitcycle
			@(t) pi*ones(size(t)), 'normal', @(t) [sin(2*pi*t); cos(2*pi*t)], 'corners', [], 'dbf', 1, 'ppw', 10) ...
			struct('par', @(t) repmat([0; 2], 1, length(t)) + [sin(2*pi*t); -cos(2*pi*t)]/2, 'gradnorm',...% Article limitCycle with d = 1 = 2r
			@(t) pi*ones(size(t)), 'normal', @(t) [sin(2*pi*t); -cos(2*pi*t)], 'corners', [], 'dbf', 1, 'ppw', 10)], ...
